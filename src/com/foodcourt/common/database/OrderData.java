...
public class OrderData {
	...
	private void init() {
		...
		orderEntries.add(new OrderEntry(new Meal(1, 100), 2));
		orderEntries.add(new OrderEntry(new Meal(2, 300), 3));
		orderEntries.add(new OrderEntry(new Meal(3, 500), 1));
		...
		orderEntries.add(new OrderEntry(new Meal(4, 100), 4));
		orderEntries.add(new OrderEntry(new Meal(5, 800), 5));
		orderEntries.add(new OrderEntry(new Meal(6, 900), 6));
		order1.setOrderEntries(orderEntries);
		addPendingOrder(order1);
		addOrder(order1);
		...
		order1.setSaleVendorID(1);
		orderEntries = new ArrayList<OrderEntry>();
		orderEntries.add(new OrderEntry(new Meal(7, 100), 1));
		orderEntries.add(new OrderEntry(new Meal(8, 400), 2));
		orderEntries.add(new OrderEntry(new Meal(9, 200), 4));
		order1.setOrderEntries(orderEntries);
		addPendingOrder(order1);
		addOrder(order1);
	}
