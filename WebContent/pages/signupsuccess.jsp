						...
						<div class="item active">
							...
							<div class="container">
								...
								<div class="carousel-caption slide-one">
									<!-- heading -->
									<h2 class="animated fadeInLeftBig"><i class="fa fa-cutlery"></i> Chúc mừng bạn đã đăng ký thành công</h2>
									<!-- paragraph -->
									<h3 class="animated fadeInRightBig">Xin vui lòng đăng nhập để tiếp tục!</h3>
									<!-- button -->
